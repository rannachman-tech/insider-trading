...
// 6. Drop synthetic + wrong-scale history points.
//    Principle: only real historical data.
//    Cutoff = last 60 days back from today. That matches what the backfill
//    script produces. Anything older was generated by the original seed
//    (untagged synthetic, wrong scale ±$10M vs real ±$2.7B). Drop it by date.
...
if (Array.isArray(snapshot.history) && snapshot.history.length > 0) {
  ...
  // Drop tagged-synthetic AND anything older than 60 days
